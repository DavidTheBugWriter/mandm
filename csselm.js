...
var $author$project$Css1$initialModel = _Utils_Tuple0;
...
var $author$project$Css1$update = F2(
	function (msg, model) {
		return model;
	});
var $author$project$Css1$DoSomething = {$: 'DoSomething'};
...
var $author$project$Css1$theme = {
	primary: $rtfeldman$elm_css$Css$hex('55af6a'),
...
var $author$project$Css1$btn = A2(
	...
	_List_fromArray(
		[
			...
			A3($rtfeldman$elm_css$Css$rgb, 250, 250, 250)),
			$rtfeldman$elm_css$Css$hover(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor($author$project$Css1$theme.primary),
...
var $rtfeldman$elm_css$Css$textShadow2 = $rtfeldman$elm_css$Css$prop2('text-shadow');
var $rtfeldman$elm_css$Html$Styled$ul = $rtfeldman$elm_css$Html$Styled$node('ul');
var $author$project$Css1$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(
								$rtfeldman$elm_css$Css$textShadow2,
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Experiments with HTML and css')
					])),
				A2(
				$author$project$Css1$btn,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Css1$DoSomething)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Lists in Elm')
					])),
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('My Grocery List')
					])),
				A2(
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										A3($rtfeldman$elm_css$Css$rgb, 20, 120, 12))
									]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Black Beans'),
								$rtfeldman$elm_css$Html$Styled$text('waga')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Limes')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Greek Yogurt')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_Nil,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Cilantro')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_Nil,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Honey')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_Nil,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Sweet Potatoes')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_Nil,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Cumin')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_Nil,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Chili Powder')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$li,
						_List_Nil,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Quinoa')
							]))
					]))
			]));
};
var $author$project$Css1$main = $elm$browser$Browser$sandbox(
	{
		init: $author$project$Css1$initialModel,
		update: $author$project$Css1$update,
		view: A2($elm$core$Basics$composeR, $author$project$Css1$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
_Platform_export({'Css1':{'init':$author$project$Css1$main(
